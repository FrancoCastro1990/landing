  ...
  const projects: Project[] = [
    {
      id: 1,
      title: 'alarm.sh',
      description: 'A comprehensive alarm management tool for the command line (Linux) that allows creating instant alarms, scheduling recurring alarms, and configuring relative timers. All alarms show desktop notifications and play sound alerts.',
      technologies: ['Bash', 'Linux', 'Shell Scripting', 'Cron Jobs', 'Desktop Notifications'],
      githubUrl: 'https://github.com/FrancoCastro1990/alarm.sh',
    },
    {
      id: 2,
      title: 'CLI-front.sh',
      description: 'A CLI tool to build different types of components for a React project. We can create components, custom hooks, contexts, etc. Creates the TSX file along with its tests automatically.',
      technologies: ['Node.js', 'CLI', 'React', 'TypeScript','Template Generation'],
        ...
        <Reveal delay={600}>
          <div className="text-center mt-12">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 border border-lightTheme-green text-lightTheme-green dark:border-darkTheme-green dark:text-darkTheme-green bg-transparent font-semibold px-6 py-3 rounded focus:outline-none focus:ring-2 focus:ring-lightTheme-green dark:focus:ring-darkTheme-green focus:ring-offset-2 focus:ring-offset-lightTheme-bg dark:focus:ring-offset-darkTheme-bg"
